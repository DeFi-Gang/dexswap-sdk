...
export declare class Pool {
     ...
     */
    constructor(tokenA: Token, tokenB: Token, fee: InitialPoolFee, sqrtRatioX96: BigintIsh, liquidity: BigintIsh, tickCurrent: number, _tickSpacing: number, ticks?: TickDataProvider | (Tick | TickConstructorArgs)[]);
